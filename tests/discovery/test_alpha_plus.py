...
alpha_plus_lpn_1 = LabelledPetriNet(
    ...
    transitions=[
            Transition("f",tid="6bc0ba57-46c3-4cfd-8c65-9d17eb48a7cd",silent=False),
            Transition("b",tid="3ec3e270-35fb-4a9d-bb00-9a523498c23e",silent=False),
            Transition("c",tid="84598e1b-ba53-4ee4-8400-22abb2fc333f",silent=False),
            Transition("d",tid="ea1b3360-4045-4a59-b147-804d747416e3",silent=False),
            Transition("a",tid="3bab0469-ef26-4adc-a6f4-f9cd4dd69a29",silent=False),
            Transition("e",tid="6af4d9fe-deda-4020-ad5e-bfb88ce23d3b",silent=False),
    ],
    arcs=[
            Arc(from_node=Place("P_({'c', 'e'},{'d', 'f'})",pid="36fdb6b7-2d5b-4802-ab11-aeeb95e3dad4"),to_node=Transition("d",tid="ea1b3360-4045-4a59-b147-804d747416e3",silent=False)),
            Arc(from_node=Transition("e",tid="6af4d9fe-deda-4020-ad5e-bfb88ce23d3b",silent=False),to_node=Place("P_({'c', 'e'},{'d', 'f'})",pid="36fdb6b7-2d5b-4802-ab11-aeeb95e3dad4")),
            Arc(from_node=Transition("b",tid="3ec3e270-35fb-4a9d-bb00-9a523498c23e",silent=False),to_node=Place("P_sink",pid="b70330d4-53ee-4db8-9c4d-16d045b7e77f")),
            Arc(from_node=Transition("c",tid="84598e1b-ba53-4ee4-8400-22abb2fc333f",silent=False),to_node=Place("P_({'c', 'e'},{'d', 'f'})",pid="36fdb6b7-2d5b-4802-ab11-aeeb95e3dad4")),
            Arc(from_node=Place("P_({'a', 'd'},{'b', 'c'})",pid="9b3d3f91-69f0-4706-b776-2ec017a0212a"),to_node=Transition("c",tid="84598e1b-ba53-4ee4-8400-22abb2fc333f",silent=False)),
            Arc(from_node=Place("P_initial",pid="e24a7736-a912-4a3f-9eae-eee069655b56"),to_node=Transition("e",tid="6af4d9fe-deda-4020-ad5e-bfb88ce23d3b",silent=False)),
            Arc(from_node=Transition("f",tid="6bc0ba57-46c3-4cfd-8c65-9d17eb48a7cd",silent=False),to_node=Place("P_sink",pid="b70330d4-53ee-4db8-9c4d-16d045b7e77f")),
            Arc(from_node=Transition("a",tid="3bab0469-ef26-4adc-a6f4-f9cd4dd69a29",silent=False),to_node=Place("P_({'a', 'd'},{'b', 'c'})",pid="9b3d3f91-69f0-4706-b776-2ec017a0212a")),
            Arc(from_node=Transition("d",tid="ea1b3360-4045-4a59-b147-804d747416e3",silent=False),to_node=Place("P_({'a', 'd'},{'b', 'c'})",pid="9b3d3f91-69f0-4706-b776-2ec017a0212a")),
            Arc(from_node=Place("P_({'c', 'e'},{'d', 'f'})",pid="36fdb6b7-2d5b-4802-ab11-aeeb95e3dad4"),to_node=Transition("f",tid="6bc0ba57-46c3-4cfd-8c65-9d17eb48a7cd",silent=False)),
            Arc(from_node=Place("P_initial",pid="e24a7736-a912-4a3f-9eae-eee069655b56"),to_node=Transition("a",tid="3bab0469-ef26-4adc-a6f4-f9cd4dd69a29",silent=False)),
            Arc(from_node=Place("P_({'a', 'd'},{'b', 'c'})",pid="9b3d3f91-69f0-4706-b776-2ec017a0212a"),to_node=Transition("b",tid="3ec3e270-35fb-4a9d-bb00-9a523498c23e",silent=False)),
    ],
    name='Petri net'
)
...
alpha_plus_lpn_2 = LabelledPetriNet(
        ...
        transitions=[
                Transition("d",tid="c4d8d2e3-942b-4472-b5a1-06e900b1dd41",silent=False),
                Transition("a",tid="12a0a456-9aa8-48cd-a609-5cf5442d3a1f",silent=False),
                Transition("c",tid="38eaecb9-2e9f-4c44-915c-59fe6288509f",silent=False),
                Transition("b",tid="e68c86b5-49e3-4bde-85e3-59c18e1dc314",silent=False),
        ],
        arcs=[
                Arc(from_node=Place("P_({'b'},{'c', 'd'})",pid="fb89b421-d116-4a15-9c40-70f0d83b4153"),to_node=Transition("d",tid="c4d8d2e3-942b-4472-b5a1-06e900b1dd41",silent=False)),
                Arc(from_node=Place("P_({'a', 'c'},{'b'})",pid="efe9d0f8-757a-4483-985b-0df527d0404e"),to_node=Transition("b",tid="e68c86b5-49e3-4bde-85e3-59c18e1dc314",silent=False)),
                Arc(from_node=Transition("d",tid="c4d8d2e3-942b-4472-b5a1-06e900b1dd41",silent=False),to_node=Place("P_sink",pid="c6afa143-dad7-40ce-a15e-5cf7dba08529")),
                Arc(from_node=Transition("b",tid="e68c86b5-49e3-4bde-85e3-59c18e1dc314",silent=False),to_node=Place("P_({'b'},{'c', 'd'})",pid="fb89b421-d116-4a15-9c40-70f0d83b4153")),
                Arc(from_node=Transition("a",tid="12a0a456-9aa8-48cd-a609-5cf5442d3a1f",silent=False),to_node=Place("P_({'a', 'c'},{'b'})",pid="efe9d0f8-757a-4483-985b-0df527d0404e")),
                Arc(from_node=Transition("c",tid="38eaecb9-2e9f-4c44-915c-59fe6288509f",silent=False),to_node=Place("P_({'a', 'c'},{'b'})",pid="efe9d0f8-757a-4483-985b-0df527d0404e")),
                Arc(from_node=Place("P_initial",pid="b2c6b279-18c8-4cf8-8ac6-9e06c2bb0fd8"),to_node=Transition("a",tid="12a0a456-9aa8-48cd-a609-5cf5442d3a1f",silent=False)),
                Arc(from_node=Place("P_({'b'},{'c', 'd'})",pid="fb89b421-d116-4a15-9c40-70f0d83b4153"),to_node=Transition("c",tid="38eaecb9-2e9f-4c44-915c-59fe6288509f",silent=False)),
        ],
        name='Petri net'
)
...
alpha_plus_lpn_3 = LabelledPetriNet(
        ...
        transitions=[
                Transition("a",tid="6b056e17-ea79-462d-ba02-f7698766588c",silent=False),
                Transition("b",tid="5552c955-359e-47b0-8fac-78a91e279e64",silent=False),
                Transition("c",tid="ad86bd4d-cc2e-47a0-95b1-d866d54dd6df",silent=False),
                Transition("d",tid="8241ba0f-cd6c-4f9d-a9f9-318b761b1b3a",silent=False),
        ],
        arcs=[
                Arc(from_node=Place("P_({'a'},{'d'})",pid="53579d87-9431-4031-833b-a307a59da0a1"),to_node=Transition("c",tid="ad86bd4d-cc2e-47a0-95b1-d866d54dd6df",silent=False)),
                Arc(from_node=Transition("a",tid="6b056e17-ea79-462d-ba02-f7698766588c",silent=False),to_node=Place("P_({'a'},{'d'})",pid="53579d87-9431-4031-833b-a307a59da0a1")),
                Arc(from_node=Place("P_({'a'},{'d'})",pid="53579d87-9431-4031-833b-a307a59da0a1"),to_node=Transition("d",tid="8241ba0f-cd6c-4f9d-a9f9-318b761b1b3a",silent=False)),
                Arc(from_node=Place("P_({'a'},{'d'})",pid="53579d87-9431-4031-833b-a307a59da0a1"),to_node=Transition("b",tid="5552c955-359e-47b0-8fac-78a91e279e64",silent=False)),
                Arc(from_node=Transition("b",tid="5552c955-359e-47b0-8fac-78a91e279e64",silent=False),to_node=Place("P_({'a'},{'d'})",pid="53579d87-9431-4031-833b-a307a59da0a1")),
                Arc(from_node=Place("P_initial",pid="58be6669-72ef-4a49-90ed-c006d6afa600"),to_node=Transition("a",tid="6b056e17-ea79-462d-ba02-f7698766588c",silent=False)),
                Arc(from_node=Transition("d",tid="8241ba0f-cd6c-4f9d-a9f9-318b761b1b3a",silent=False),to_node=Place("P_sink",pid="b62de061-6bf9-4cd3-8929-77821e042ea4")),
                Arc(from_node=Transition("c",tid="ad86bd4d-cc2e-47a0-95b1-d866d54dd6df",silent=False),to_node=Place("P_({'a'},{'d'})",pid="53579d87-9431-4031-833b-a307a59da0a1")),
        ],
        name='Petri net'
)
...
alpha_plus_lpn_4 = LabelledPetriNet(
        ...
        transitions=[
                Transition("e",tid="ffe1fce2-e81a-4f6c-b4b9-817b9fe558fe",silent=False), 
                Transition("d",tid="233e8e3f-af75-44ca-8a91-c0457840ea72",silent=False), 
                Transition("a",tid="67f34c5e-1cba-475f-8c0a-d2429d5ecb4f",silent=False), 
                Transition("b",tid="2020a137-1dae-4534-b4aa-38a48c5ae238",silent=False), 
                Transition("c",tid="9cc9da20-78ce-4a7f-b9d7-35ce7c7fcc41",silent=False), 
                Transition("g",tid="d4d2b513-90bb-4651-9607-37beb3a73af9",silent=False), 
                Transition("h",tid="6832baf4-c712-416c-9327-f19c8f736419",silent=False), 
                Transition("f",tid="ffbfd3e5-a05e-4b90-82ea-f938f47ba85c",silent=False), 
        ],
        arcs=[
                Arc(from_node=Transition("f",tid="ffbfd3e5-a05e-4b90-82ea-f938f47ba85c",silent=False),to_node=Place("P_({'f'},{'g', 'h'})",pid="3ce5ed1e-c6cb-4c63-aa0c-a16b1f467f76")),     
                Arc(from_node=Place("P_({'c', 'g'},{'d', 'f'})",pid="00bc70ae-8007-46c7-9442-f05f23d114d0"),to_node=Transition("d",tid="233e8e3f-af75-44ca-8a91-c0457840ea72",silent=False)),
                Arc(from_node=Transition("h",tid="6832baf4-c712-416c-9327-f19c8f736419",silent=False),to_node=Place("P_sink",pid="958f7ae7-6525-4c5d-87dd-5cb991e2fc8d")),
                Arc(from_node=Place("P_({'c', 'g'},{'d', 'f'})",pid="00bc70ae-8007-46c7-9442-f05f23d114d0"),to_node=Transition("e",tid="ffe1fce2-e81a-4f6c-b4b9-817b9fe558fe",silent=False)),
                Arc(from_node=Transition("e",tid="ffe1fce2-e81a-4f6c-b4b9-817b9fe558fe",silent=False),to_node=Place("P_({'c', 'g'},{'d', 'f'})",pid="00bc70ae-8007-46c7-9442-f05f23d114d0")),
                Arc(from_node=Place("P_({'a', 'd'},{'c'})",pid="2782e2ef-3947-4b94-b61f-af462dfe4c6a"),to_node=Transition("b",tid="2020a137-1dae-4534-b4aa-38a48c5ae238",silent=False)),     
                Arc(from_node=Transition("b",tid="2020a137-1dae-4534-b4aa-38a48c5ae238",silent=False),to_node=Place("P_({'a', 'd'},{'c'})",pid="2782e2ef-3947-4b94-b61f-af462dfe4c6a")),     
                Arc(from_node=Place("P_({'a', 'd'},{'c'})",pid="2782e2ef-3947-4b94-b61f-af462dfe4c6a"),to_node=Transition("c",tid="9cc9da20-78ce-4a7f-b9d7-35ce7c7fcc41",silent=False)),     
                Arc(from_node=Transition("g",tid="d4d2b513-90bb-4651-9607-37beb3a73af9",silent=False),to_node=Place("P_({'c', 'g'},{'d', 'f'})",pid="00bc70ae-8007-46c7-9442-f05f23d114d0")),
                Arc(from_node=Place("P_initial",pid="45452dc7-3d9d-4cca-a585-cf26ddd02526"),to_node=Transition("a",tid="67f34c5e-1cba-475f-8c0a-d2429d5ecb4f",silent=False)),
                Arc(from_node=Transition("a",tid="67f34c5e-1cba-475f-8c0a-d2429d5ecb4f",silent=False),to_node=Place("P_({'a', 'd'},{'c'})",pid="2782e2ef-3947-4b94-b61f-af462dfe4c6a")),     
                Arc(from_node=Place("P_({'c', 'g'},{'d', 'f'})",pid="00bc70ae-8007-46c7-9442-f05f23d114d0"),to_node=Transition("f",tid="ffbfd3e5-a05e-4b90-82ea-f938f47ba85c",silent=False)),
                Arc(from_node=Transition("c",tid="9cc9da20-78ce-4a7f-b9d7-35ce7c7fcc41",silent=False),to_node=Place("P_({'c', 'g'},{'d', 'f'})",pid="00bc70ae-8007-46c7-9442-f05f23d114d0")),
                Arc(from_node=Place("P_({'f'},{'g', 'h'})",pid="3ce5ed1e-c6cb-4c63-aa0c-a16b1f467f76"),to_node=Transition("g",tid="d4d2b513-90bb-4651-9607-37beb3a73af9",silent=False)),     
                Arc(from_node=Transition("d",tid="233e8e3f-af75-44ca-8a91-c0457840ea72",silent=False),to_node=Place("P_({'a', 'd'},{'c'})",pid="2782e2ef-3947-4b94-b61f-af462dfe4c6a")),     
                Arc(from_node=Place("P_({'f'},{'g', 'h'})",pid="3ce5ed1e-c6cb-4c63-aa0c-a16b1f467f76"),to_node=Transition("h",tid="6832baf4-c712-416c-9327-f19c8f736419",silent=False)),     
        ],
        name='Petri net'
)
...
alpha_plus_lpn_5 = LabelledPetriNet(
        ...
        transitions=[
                Transition("a",tid="beac9b42-59a7-4ff6-8108-dce47d036881",silent=False), 
                Transition("c",tid="631534d2-7226-47ed-a9be-d753b22a1981",silent=False), 
                Transition("b",tid="a91aa8e9-1ade-4186-9a21-226b0d69b2c6",silent=False), 
                Transition("j",tid="b15fa8ea-71a9-4a27-8253-2717d2bf3fa9",silent=False), 
                Transition("d",tid="2821344a-cd9e-4ca9-a858-3642b8b34607",silent=False), 
                Transition("h",tid="267669ee-59a7-4857-8b02-0427a6c166b6",silent=False), 
                Transition("z",tid="ef2278f3-c3ea-4430-b339-555d9b96767c",silent=False), 
                Transition("i",tid="8b1a4029-1c1b-4f6b-9c0e-bee77c5fe141",silent=False), 
                Transition("f",tid="91a41ea3-9f17-49d7-8133-6d87cbc9a644",silent=False), 
                Transition("e",tid="46067b76-4630-4594-bf26-3c19ac2df923",silent=False), 
        ],
        arcs=[
                Arc(from_node=Transition("a",tid="beac9b42-59a7-4ff6-8108-dce47d036881",silent=False),to_node=Place("P_({'a'},{'d'})",pid="a557921f-68f9-4f14-9a54-08b2168b75bb")),
                Arc(from_node=Place("P_({'d'},{'h'})",pid="4302656f-be39-4eb7-8796-36a990f6edf8"),to_node=Transition("z",tid="ef2278f3-c3ea-4430-b339-555d9b96767c",silent=False)),
                Arc(from_node=Transition("j",tid="b15fa8ea-71a9-4a27-8253-2717d2bf3fa9",silent=False),to_node=Place("P_sink",pid="dbdd0237-8ad1-41e6-8304-b936ae99afd0")),
                Arc(from_node=Place("P_({'a'},{'d'})",pid="a557921f-68f9-4f14-9a54-08b2168b75bb"),to_node=Transition("d",tid="2821344a-cd9e-4ca9-a858-3642b8b34607",silent=False)),
                Arc(from_node=Place("P_({'i'},{'j'})",pid="549d1720-266c-488e-abce-b4d3b295ad51"),to_node=Transition("j",tid="b15fa8ea-71a9-4a27-8253-2717d2bf3fa9",silent=False)),
                Arc(from_node=Transition("i",tid="8b1a4029-1c1b-4f6b-9c0e-bee77c5fe141",silent=False),to_node=Place("P_({'i'},{'j'})",pid="549d1720-266c-488e-abce-b4d3b295ad51")),
                Arc(from_node=Place("P_({'f'},{'e', 'i'})",pid="5e406806-d04f-4d26-92b4-c600bee51343"),to_node=Transition("e",tid="46067b76-4630-4594-bf26-3c19ac2df923",silent=False)),     
                Arc(from_node=Transition("e",tid="46067b76-4630-4594-bf26-3c19ac2df923",silent=False),to_node=Place("P_({'b', 'e'},{'c', 'f'})",pid="2291bfce-d341-4fa8-bb14-a88d09a95a5c")),
                Arc(from_node=Transition("z",tid="ef2278f3-c3ea-4430-b339-555d9b96767c",silent=False),to_node=Place("P_({'d'},{'h'})",pid="4302656f-be39-4eb7-8796-36a990f6edf8")),
                Arc(from_node=Place("P_initial",pid="233785f2-d1f7-4ca5-98b9-ec763b64e15d"),to_node=Transition("a",tid="beac9b42-59a7-4ff6-8108-dce47d036881",silent=False)),
                Arc(from_node=Place("P_({'h'},{'j'})",pid="af98d503-9569-4022-8009-3096c1e68829"),to_node=Transition("j",tid="b15fa8ea-71a9-4a27-8253-2717d2bf3fa9",silent=False)),
                Arc(from_node=Place("P_({'d'},{'h'})",pid="4302656f-be39-4eb7-8796-36a990f6edf8"),to_node=Transition("h",tid="267669ee-59a7-4857-8b02-0427a6c166b6",silent=False)),
                Arc(from_node=Transition("f",tid="91a41ea3-9f17-49d7-8133-6d87cbc9a644",silent=False),to_node=Place("P_({'f'},{'e', 'i'})",pid="5e406806-d04f-4d26-92b4-c600bee51343")),     
                Arc(from_node=Place("P_({'a', 'c'},{'b'})",pid="8f801b01-51a2-4070-9aef-f5eb657a40b0"),to_node=Transition("b",tid="a91aa8e9-1ade-4186-9a21-226b0d69b2c6",silent=False)),     
                Arc(from_node=Transition("b",tid="a91aa8e9-1ade-4186-9a21-226b0d69b2c6",silent=False),to_node=Place("P_({'b', 'e'},{'c', 'f'})",pid="2291bfce-d341-4fa8-bb14-a88d09a95a5c")),
                Arc(from_node=Place("P_({'b', 'e'},{'c', 'f'})",pid="2291bfce-d341-4fa8-bb14-a88d09a95a5c"),to_node=Transition("c",tid="631534d2-7226-47ed-a9be-d753b22a1981",silent=False)),
                Arc(from_node=Place("P_({'f'},{'e', 'i'})",pid="5e406806-d04f-4d26-92b4-c600bee51343"),to_node=Transition("i",tid="8b1a4029-1c1b-4f6b-9c0e-bee77c5fe141",silent=False)),     
                Arc(from_node=Transition("a",tid="beac9b42-59a7-4ff6-8108-dce47d036881",silent=False),to_node=Place("P_({'a', 'c'},{'b'})",pid="8f801b01-51a2-4070-9aef-f5eb657a40b0")),     
                Arc(from_node=Transition("c",tid="631534d2-7226-47ed-a9be-d753b22a1981",silent=False),to_node=Place("P_({'a', 'c'},{'b'})",pid="8f801b01-51a2-4070-9aef-f5eb657a40b0")),     
                Arc(from_node=Transition("d",tid="2821344a-cd9e-4ca9-a858-3642b8b34607",silent=False),to_node=Place("P_({'d'},{'h'})",pid="4302656f-be39-4eb7-8796-36a990f6edf8")),
                Arc(from_node=Place("P_({'b', 'e'},{'c', 'f'})",pid="2291bfce-d341-4fa8-bb14-a88d09a95a5c"),to_node=Transition("f",tid="91a41ea3-9f17-49d7-8133-6d87cbc9a644",silent=False)),
                Arc(from_node=Transition("h",tid="267669ee-59a7-4857-8b02-0427a6c166b6",silent=False),to_node=Place("P_({'h'},{'j'})",pid="af98d503-9569-4022-8009-3096c1e68829")),
        ],
        name='Petri net'
)
